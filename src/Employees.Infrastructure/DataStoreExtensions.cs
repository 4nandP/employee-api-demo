...
namespace Employees.Infrastructure
{
    ...
    public static class DataStoreExtensions
    {
        ...
        {
            var collection = dataStore.GetCollection<Employees.Infrastructure.Data.Entities.Employee>();

            collection.ReplaceOne("Test123",
                new Employees.Infrastructure.Data.Entities.Employee
                {
            ...
            collection.ReplaceOne("Test456",
                new Employees.Infrastructure.Data.Entities.Employee
                {
                    ...
                    IsActive = true,
                    PrimaryPhone = new Employees.Infrastructure.Data.Entities.Phone { FreeFormNumber = "03 5365 9595" },
                    PrimaryEmailAddress = new Employees.Infrastructure.Data.Entities.EmailAddress { Address = "joshuaallen@armyspy.com" },
            ...
            collection.ReplaceOne("Test789",
                new Employees.Infrastructure.Data.Entities.Employee
                {
                    ...
                    IsActive = false,
                    PrimaryPhone = new Employees.Infrastructure.Data.Entities.Phone { FreeFormNumber = "08 9067 3927" },
                    PrimaryEmailAddress = new Employees.Infrastructure.Data.Entities.EmailAddress { Address = "alanamcguinness@jourrapide.com" },
                    EmployeeType = "Regular",
                    Status = "Active",
                    Id = "Test789"
                }, upsert: true
